...
print("11101001")
```
which simply returns the total pattern `"11101001"`, and hence is of size equal to input $$c + \mid 11101001 \mid $$ = c + 8 (where $c$ is equal to however many bits is required to encode the symbols `print""()}`. 
