...
Hai Hu, He Zhou, Zuoyu Tian, Yiwen Zhang, Yina Patterson, Yanting Li, Yixin Nie, **Kyle Richardson**.  (**2021**) **Investigating Transfer Learning in Multi-lingual Pre-trained Language Models through Chinese Natural Language Inference** *Findings of ACL* (to appear) \[[data](https://github.com/huhailinguist/ChineseNLIProbing)]
...
Gregor Betz, Christian Voigt, **Kyle Richardson**.  (**2021**) [**Critical Thinking for Language Models**](https://arxiv.org/abs/2009.07185) *Proceedings of International Conference on Computational Semantics*  (**IWCS 2021**) (accepted) \[[arxiv](https://arxiv.org/abs/2009.07185)] \[[data](https://github.com/debatelab/aacorpus)] \[[models](https://huggingface.co/debatelab)] \[[blog](https://debatelab.github.io/journal/critical-thinking-language-models.html)]
